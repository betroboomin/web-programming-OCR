<!doctype html>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <div class="card">
                <h5 class="text-center mb-4">Login into OCR-GIX</h5>
                <form class="form-card" onsubmit="event.preventDefault()">
                    ...
                    <div class="row justify-content-between text-left">
                        <div > <label class="form-control-label px-3">Don't have an account yet?</label> <a href="/signin.php" style="cursor:pointer;" ><label class="form-control-label px-3">Signin</label></a> </div>
                        </div>
